...
def ____Pronoun():
	...
	ruwords["ты (муж)"]=StProNoun("ты","вы",1,True,'m','ed','ip')
	ruwords["ты (жен)"]=StProNoun("ты","вы",1,True,'g','ed','ip')
	...
	ruwords["вы"]=StProNoun("вы","ты (муж)",1,True,'m','mn','ip')
...
def ____Num():
	...
	add_runum('восемь'       ,'>=5','mn','сем'          ,{   'mn':('ь','и' ,'и' ,('ь', 'ь'),'ью' ,'и' ), }    )
